...
const JoinUs = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      setMessage({ type: 'error', text: 'Failed to process image. Please try another one.' });
    }
  };
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-black' : 'bg-white'}`}>
      ...
      <section className="pt-32 pb-12 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-3 mb-6">
            <h1 className={`text-6xl md:text-8xl font-heading font-bold animate-float ${theme === 'dark' ? 'gradient-text' : 'text-gray-900'
              }`}>
              Join The Team
            </h1>
          </div>
          <p className={`text-xl md:text-2xl font-body max-w-2xl mx-auto ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
            }`}>
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto form-container">
          <div className={`rounded-3xl p-8 md:p-12 border ${theme === 'dark'
            ...
            {message.text && (
              <div className={`mb-6 p-4 rounded-xl flex items-center gap-3 border ${message.type === 'success'
                ...
                <p className={`font-body ${message.type === 'success'
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col-reverse md:flex-row gap-8 items-start">
                {/* Name - Takes full width on mobile, remaining space on desktop */}
                <div className="w-full md:flex-1">
                  <label className={`block text-sm font-body font-medium mb-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                    }`}>
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 border rounded-xl font-body transition-all duration-300 ${theme === 'dark'
                ...
                {/* Photo Upload - Circular, Top Right on Desktop */}
                <div className="flex-shrink-0 mx-auto md:mx-0">
                  <label className={`block text-sm font-body font-medium mb-2 text-center md:text-left ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                    }`}>
                    Photo <span className="text-red-400">*</span>
                  </label>

                  <div className="relative group">
                    <div className={`w-32 h-32 rounded-full border-2 border-dashed flex items-center justify-center overflow-hidden transition-all relative ${theme === 'dark'
                      ? 'border-gray-600 bg-gray-900/50 hover:border-neon-cyan'
                      ...
                      {photoPreview ? (
                        <>
                          ...
                          />
                          {/* Overlay on hover to show cleanup/change option */}
                        ...
                        <div className="text-center p-2">
                          <Upload size={24} className={`mx-auto mb-1 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`} />
                          <p className={`text-[10px] uppercase font-bold tracking-wider ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}>
                            Upload
                          </p>
                        </div>
                      )}
                    ...
                    {photoPreview && (
                      <button
                        type="button"
                        onClick={removePhoto}
                        className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full p-1.5 shadow-md hover:bg-red-600 transition-transform hover:scale-110 z-10"
                        title="Remove photo"
                      >
                        <X size={14} />
                      </button>
              ...
              <div>
                ...
                />
                <p className={`text-xs mt-1 font-body ${theme === 'dark' ? 'text-gray-500' : 'text-gray-500'
                  }`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl font-body transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed ${theme === 'dark'
                      ? 'bg-gray-900/50 border-gray-700 text-white placeholder:text-gray-500 focus:border-neon-cyan focus:bg-gray-900/70'
                      : 'bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200'
                      } focus:outline-none`}
              ...
              <div className={`flex items-center gap-3 p-4 rounded-xl border ${theme === 'dark'
                ...
                <input
                  ...
                  className={`w-5 h-5 rounded cursor-pointer ${theme === 'dark'
                ...
                />
                <label htmlFor="sameAsPhone" className={`text-sm font-body cursor-pointer select-none ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                  }`}>
                  WhatsApp number is same as phone number
                </label>
              </div>

              {/* Course, Department, Section, Year */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className={`w-full px-4 py-3 border rounded-xl font-body transition-all duration-300 cursor-pointer ${theme === 'dark'
