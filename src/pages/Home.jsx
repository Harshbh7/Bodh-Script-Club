  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-black' : 'bg-white'}`}>
        ...
        <div className="text-center max-w-6xl relative z-10">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative group">
              <div className={`absolute inset-0 rounded-full blur-2xl opacity-30 group-hover:opacity-50 transition-opacity duration-500 ${
                theme === 'dark'
          ...
          <div className="mb-6 inline-block">
            <span className={`px-6 py-2 rounded-full font-mono text-sm animate-pulse-slow ${
              theme === 'dark'
          ...
          <h1 className={`text-6xl md:text-8xl lg:text-9xl font-heading font-bold mb-6 animate-float ${
            theme === 'dark' ? 'gradient-text' : 'text-gray-900'
          }`}>
            BODH SCRIPT CLUB
          </h1>
          
          <p className={`text-2xl md:text-3xl font-body mb-4 ${
            theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
          }`}>
            Where Code Meets <span className={`font-semibold ${theme === 'dark' ? 'text-neon-purple' : 'text-purple-600'}`}>Creativity</span>
          </p>
          
          <p className={`text-lg md:text-xl font-body mb-12 max-w-3xl mx-auto leading-relaxed ${
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link 
              to="/join" 
              className={`group px-10 py-5 rounded-xl font-body font-semibold text-lg hover:scale-105 transition-all duration-300 shadow-lg ${
                theme === 'dark'
            ...
            <Link 
              to="/events" 
              className={`px-10 py-5 rounded-xl font-body font-semibold text-lg transition-all duration-300 ${
                theme === 'dark'
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto">
            {[
              ...
              <div key={idx} className={`p-6 rounded-xl card-hover border ${
                theme === 'dark'
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className={`group p-8 rounded-2xl card-hover border ${
                theme === 'dark'
                  ? 'glass-effect border-gray-800'
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {galleryImages.slice(0, 8).map((img, idx) => (
              <div
                key={img.id}
                className={`relative overflow-hidden rounded-2xl group cursor-pointer border ${
          ...
          <div className="text-center">
            <Link
              to="/gallery"
              className={`inline-flex items-center gap-2 px-8 py-4 rounded-xl font-body font-semibold transition-all duration-300 group ${
                theme === 'dark'
                  ? 'neon-border hover:bg-neon-blue/10'
                  : 'border-2 border-blue-600 text-blue-600 hover:bg-blue-50'
              }`}
      ...
      {events.length > 0 && (
        <section className="py-32 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className={`text-5xl md:text-7xl font-heading font-bold text-center mb-20 ${
              theme === 'dark' ? 'gradient-text' : 'text-gray-900'
            }`}>
              Upcoming Events
            </h2>
              ...
              {events.map(event => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className={`font-body text-sm mb-4 line-clamp-2 ${
                      theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                    }`}>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`hover:underline font-body text-sm ${
