      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex justify-between items-center h-20 w-full">
          <Link to="/" className="nav-item flex items-center gap-2 md:gap-3 flex-shrink-0">
            ...
            />
            <h1 className={`text-xl sm:text-2xl md:text-3xl font-heading font-bold tracking-wider whitespace-nowrap ${
          ...
          <div className="hidden md:flex items-center space-x-6">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`nav-item font-body font-medium text-lg transition-all duration-300 relative group ${
            ...
            {user && (
              <div className="relative user-dropdown">
                ...
                {showDropdown && (
                  <div className={`absolute right-0 mt-2 w-56 rounded-xl shadow-xl overflow-hidden animate-fadeIn ${
                    theme === 'dark'
      ...
      {isOpen && (
        <div className={`md:hidden ${
          ...
          <div className="px-4 pt-2 pb-4 space-y-2">
            ...
            <button
              onClick={toggleTheme}
              className={`w-full flex items-center gap-2 py-3 font-body text-lg ${
            ...
            {user && (
              <>
                ...
                <Link
                  to="/my-registrations"
                  className={`flex items-center gap-2 py-3 font-body ${
